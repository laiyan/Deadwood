...
//    private ArrayList<Integer> sy = null;
   ...
   public void parseSX(Element e){
      NodeList area = e.getElementsByTagName("area");
      Element a = (Element) area.item(1);
      this.sx = Integer.parseInt(a.getAttribute("x"));
   }
   
      public void parseSY(Element e){
      NodeList area = e.getElementsByTagName("area");
      Element a = (Element) area.item(1);
      this.sy = Integer.parseInt(a.getAttribute("y"));
   }
   
//    public void parseSY(Element e){
//       NodeList area = e.getElementsByTagName("area");
//       
// //       for(int i = 1; i <= getNumShots(); i++){
//          Element a = (Element) area.item(1);
//          this.sx = Integer.parseInt(a.getAttribute("y"));
// //       }
//       
//    }
}
