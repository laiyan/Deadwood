...
// public void addShotMark(Stage s){
//    shotLabel = new JLabel();
//    ImageIcon sIcon = new ImageIcon("shot.png");
//    shotLabel.setIcon(sIcon);
//     for(int i = 0; i < s.getSX().size(); i++){
//       shotLabel.setBounds(s.getSX().get(i),s.getSY().get(i), 40, 40);
...
// }
 ...
 shotLabel = new JLabel();
 ImageIcon cbIcon = new ImageIcon("shot.png");
 shotLabel.setIcon(cbIcon);
 shotLabel.setBounds(s.getSX(), s.getSY(), 40, 40);
